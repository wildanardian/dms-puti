...
@section('breadcrumb')
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('units.index') }}">Users</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 ">
                            <div class="form-group">
                                ...
                                <select id="select-unit" name="select_parent_unit" placeholder="Pilih Unit"
                                    autocomplete="off" class="form-control form-control-sm">
                                    <option value="">Pilih Unit</option>
                                    @foreach ($units as $item)
                                        <option value="{{ $item->id }}"
                                            @if (isset($unit) && $unit->parent_id == $item->id) selected @endif>
                                            {{ $item->name }}</option>
                                    @endforeach
                                </select>
