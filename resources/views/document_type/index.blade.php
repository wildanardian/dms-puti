...
@section('button')
    <a href="{{ route('document-types.create') }}" class="btn d-flex align-items-center text-white" style="background-color: #9f1521">
        ...
        $(document).on('click', '.delete-item', function(e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ route('document-types.destroy', ':document_type') }}".replace(':document_type',
                            id),
                        type: 'POST',
                        data: {
                            _token: "{{ csrf_token() }}",
