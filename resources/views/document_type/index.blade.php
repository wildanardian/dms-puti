...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Kelola Tipe Dokumen</li>
    </ol>
@endsection

@section('button')
    <a href="{{ route('document-types.create') }}" class="btn d-flex align-items-center text-white"
        style="background-color: #9f1521">
        <i class="fa-solid fa-plus fa-lg me-2"></i>
        <span>Buat Tipe Dokumen</span>
    </a>
@endsection
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
            <div class="widget-content widget-content-area br-8">
                <div class="table-responsive">
                    <table id="table_document" class="table dt-table-hover dataTable no-footer" style="width: 100%">
                        <thead>
                            <tr role="row">
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            <div class="d-inline dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <li><a class="dropdown-item" href="{{ route('document-types.index') }}/${data}/edit"><i class="fa-solid fa-pen-to-square me-2"></i>Ubah</a></li>
            ...
            $(document).on('click', '.delete-item', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('document-types.destroy', ':document_type') }}"
                                .replace(':document_type',
                                    id),
                            type: 'POST',
                            data: {
                                _token: "{{ csrf_token() }}",
